...
geoXML3.parser = function(options) {
    ...
    var createMarker = function(placemark, doc) {
        ...
        var infoWindowOptions = geoXML3.combineOptions(parserOptions.infoWindowOptions, {
        	width: 300,
            content: '<div class="infotool-gmap" style="font-size:12px;">' +
				'<h6 style="font-size:13px;text-align:left;"><a style="text-decoration:none;" href="' + placemark.permalink + '">' + placemark.name + '</a></h6>' +
				'<p style="margin:0;padding:0;">' + placemark.description + 
				' <a href="' + placemark.permalink + '">Lire la suite</a>' + '</p>' + '</div>',
